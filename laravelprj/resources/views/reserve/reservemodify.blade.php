    ...
    <div class="row container__forum">
        ...
        <div class="col-md-9">
            <article>
                                ...
                                <tr>
                                    <td align="center" style="padding: 0.0rem;" colspan="2">
                                        ...
                                        @if ($month > 1 && $month+1 > $curmonth)
                                            <a id="booktag" href="{{ route('admin.reserveedit',["reserveid" => $reserveid, "userid" => $userid, "username" => $username, "hallid" => $hall->id, "hallname" => $hall->hallname, "reservedate" => $reservedate, "reservereason" => $reservereason, "reservetime_cur" => $reservetime_cur, "month" => $month-1])}}">
                                                <b>prev</b>
                                            </a>
                                        @else
                                        ...
                                        &nbsp;|{{$year}}. {{$month}}|&nbsp
                                        @if ($month < 12)
                                            <a id="booktag" href="{{ route('admin.reserveedit',["reserveid" => $reserveid, "userid" => $userid, "username" => $username, "hallid" => $hall->id, "hallname" => $hall->hallname, "reservedate" => $reservedate, "reservedate" => $reservedate, "reservereason" => $reservereason, "reservetime_cur" => $reservetime_cur, "month" => $month+1])}}">
                                                <!-- 다음달 --><b>next</b>
                                            </a>
                                        @else
                                        @endif
                ...
                @include('reserve.partial.modify')
            </article>
        </div>
    </div>
@stop
