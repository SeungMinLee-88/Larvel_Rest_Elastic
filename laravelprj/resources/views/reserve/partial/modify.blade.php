...
<form name="reserveform" id="reserveform" action="{{ route('admin.reserveedit',["reserve_id" => $reserveid])}}" method="post">
    {!! csrf_field() !!}
    ...
    <div id="book_content" align="center" style="width:850px;">
        <table width="700px"  style="margin-left:20px;"  align="center" border="0">
            <tr>
                ...
                <td>
                    <input type="text" name="reserve_date" id="reserve_date" value="{{ old('reserve_date') }}"  value="" style="width:100%; border: 0;" readonly>
                </td>
            </tr>
            <tr>
                <td bgcolor="#f5f5f5" align="center">
                ...
                <td>
                    ...
                    <input type="hidden" name="user_id" value="{{$userid}}" style="width:100%; border: 0;"
                           placeholder="please select user." readonly>
                </td>
            </tr>
