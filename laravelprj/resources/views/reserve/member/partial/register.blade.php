...
<form name="reserveform" id="reserveform" action="{{ route('member.reservestore')}}" method="post">
    {!! csrf_field() !!}
    ...
    <div id="book_content" align="center" style="width:850px;">
        <table width="700px"  style="margin-left:20px;"  align="center" border="0">
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="user_name" value="{{Request::User()->name}}" style="width:100%; border: 0;" readonly/>
                    <input type="hidden" name="user_id" value="{{Request::User()->id}}" style="width:100%; border: 0;"  readonly>
                </td>
            </tr>
            <tr>
                <td bgcolor="#f5f5f5" align="center">
                ...
                <td>
                    <textarea name="reserve_reason" rows=5 style="width:100%; height:100%; border: 0;">reason</textarea>
                </td>
            </tr>
        </table>
